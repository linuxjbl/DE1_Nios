...
module nios2e_mm_interconnect_0 (
	...
	wire  [94:0] cmd_mux_001_src_data;                                                               // cmd_mux_001:src_data -> nios2_qsys_0_jtag_debug_module_agent:cp_data
	...
	wire  [94:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> PERIOD0_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                              // PERIOD0_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [6:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> PERIOD0_s1_agent:cp_channel
	...
	wire  [94:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> DECODE0_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                              // DECODE0_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [6:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> DECODE0_s1_agent:cp_channel
	...
	wire  [95:0] push_s1_agent_rf_source_data;                                                       // PUSH_s1_agent:rf_source_data -> PUSH_s1_agent_rsp_fifo:in_data
	...
	wire  [95:0] push_s1_agent_rsp_fifo_out_data;                                                    // PUSH_s1_agent_rsp_fifo:out_data -> PUSH_s1_agent:rf_sink_data
	...
	wire  [94:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> PUSH_s1_agent:cp_data
	wire         cmd_mux_006_src_ready;                                                              // PUSH_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [6:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> PUSH_s1_agent:cp_channel
	...
	wire  [94:0] nios2_qsys_0_jtag_debug_module_agent_rp_data;                                       // nios2_qsys_0_jtag_debug_module_agent:rp_data -> router_003:sink_data
	...
	wire  [94:0] period0_s1_agent_rp_data;                                                           // PERIOD0_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [94:0] decode0_s1_agent_rp_data;                                                           // DECODE0_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [94:0] push_s1_agent_rp_data;                                                              // PUSH_s1_agent:rp_data -> router_008:sink_data
