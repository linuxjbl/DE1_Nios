	nios2e u0 (
		...
		.decode1_external_connection_export (<connected-to-decode1_external_connection_export>), // decode1_external_connection.export
		.decode2_external_connection_export (<connected-to-decode2_external_connection_export>), // decode2_external_connection.export
		.decode3_external_connection_export (<connected-to-decode3_external_connection_export>), // decode3_external_connection.export
		.decode4_external_connection_export (<connected-to-decode4_external_connection_export>), // decode4_external_connection.export
		.decode5_external_connection_export (<connected-to-decode5_external_connection_export>), // decode5_external_connection.export
		.decode6_external_connection_export (<connected-to-decode6_external_connection_export>), // decode6_external_connection.export
		.decode7_external_connection_export (<connected-to-decode7_external_connection_export>), // decode7_external_connection.export
		...
		.period3_external_connection_export (<connected-to-period3_external_connection_export>), // period3_external_connection.export
		.period4_external_connection_export (<connected-to-period4_external_connection_export>), // period4_external_connection.export
		.period5_external_connection_export (<connected-to-period5_external_connection_export>), // period5_external_connection.export
		.period6_external_connection_export (<connected-to-period6_external_connection_export>), // period6_external_connection.export
		.period7_external_connection_export (<connected-to-period7_external_connection_export>), // period7_external_connection.export
