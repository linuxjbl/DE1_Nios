...
module nios2e_mm_interconnect_0 (
	...
	wire  [91:0] cmd_mux_src_data;                                                                   // cmd_mux:src_data -> nios2_qsys_0_jtag_debug_module_agent:cp_data
	...
	wire  [17:0] period0_s1_agent_m0_address;                                                        // PERIOD0_s1_agent:m0_address -> PERIOD0_s1_translator:uav_address
	...
	wire  [92:0] period0_s1_agent_rf_source_data;                                                    // PERIOD0_s1_agent:rf_source_data -> PERIOD0_s1_agent_rsp_fifo:in_data
	...
	wire  [92:0] period0_s1_agent_rsp_fifo_out_data;                                                 // PERIOD0_s1_agent_rsp_fifo:out_data -> PERIOD0_s1_agent:rf_sink_data
	...
	wire  [91:0] cmd_mux_002_src_data;                                                               // cmd_mux_002:src_data -> PERIOD0_s1_agent:cp_data
	wire         cmd_mux_002_src_ready;                                                              // PERIOD0_s1_agent:cp_ready -> cmd_mux_002:src_ready
	wire   [3:0] cmd_mux_002_src_channel;                                                            // cmd_mux_002:src_channel -> PERIOD0_s1_agent:cp_channel
	...
	wire  [17:0] decode0_s1_agent_m0_address;                                                        // DECODE0_s1_agent:m0_address -> DECODE0_s1_translator:uav_address
	...
	wire  [92:0] decode0_s1_agent_rf_source_data;                                                    // DECODE0_s1_agent:rf_source_data -> DECODE0_s1_agent_rsp_fifo:in_data
	...
	wire  [92:0] decode0_s1_agent_rsp_fifo_out_data;                                                 // DECODE0_s1_agent_rsp_fifo:out_data -> DECODE0_s1_agent:rf_sink_data
	...
	wire  [91:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> DECODE0_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                              // DECODE0_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [3:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> DECODE0_s1_agent:cp_channel
	...
	wire  [91:0] nios2_qsys_0_jtag_debug_module_agent_rp_data;                                       // nios2_qsys_0_jtag_debug_module_agent:rp_data -> router_002:sink_data
	...
	wire  [91:0] period0_s1_agent_rp_data;                                                           // PERIOD0_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [91:0] decode0_s1_agent_rp_data;                                                           // DECODE0_s1_agent:rp_data -> router_005:sink_data
